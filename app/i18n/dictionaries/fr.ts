...
export const fr: Dictionary = {
  ...
  caseStudy: {
    ...
    previousMedia: "Médias précédents",
    nextMedia: "Médias suivants",
    selectMedia: "Afficher : {title}",
    watchVideo: "Voir la vidéo",
    openVideo: "Ouvrir la vidéo : {title}",
    videoDialogLabel: "Lecteur vidéo : {title}",
    closeVideo: "Fermer la vidéo",
    videoQuality: "Qualité",
    videoOriginal: "Originale",
    playVideo: "Lire la vidéo",
    pauseVideo: "Mettre la vidéo en pause",
    seekVideo: "Position dans la vidéo",
    muteVideo: "Couper le son",
    unmuteVideo: "Activer le son",
    videoSettings: "Réglages de la vidéo",
