...
public final class AdminCliApplication {
    ...
    public static void main(String[] args)throws Exception{
        ...
        try(var connection=DriverManager.getConnection(url,user,password)){
            switch(command){
                ...
                default->throw new IllegalArgumentException("Use -PadminCommand=create|reset|disable|enable|delete");
            }
        }
    }
    ...
    private static String requireStrongPassword(){var value=require("ADMIN_INITIAL_PASSWORD");if(value.length()<14)throw new IllegalArgumentException("ADMIN_INITIAL_PASSWORD must be at least 14 characters long.");return value;}
    private static String require(String name){var value=System.getenv(name);if(value==null||value.isBlank())throw new IllegalArgumentException(name+" is required.");return value;}
